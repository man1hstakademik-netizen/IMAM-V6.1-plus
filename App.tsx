...
import { Permission } from './src/auth/rbac';
...
const App: React.FC = () => {
  ...
  const renderCurrentView = () => {
    switch (currentView) {
      ...
      case ViewState.STUDENTS: return <ProtectedRoute requiredPermission={Permission.VIEW_SISWA} userRole={userRole} onBack={backToDashboard}><StudentData onBack={backToDashboard} userRole={userRole} /></ProtectedRoute>;
      case ViewState.TEACHERS: return <ProtectedRoute requiredPermission={Permission.VIEW_USERS} userRole={userRole} onBack={backToDashboard}><TeacherData onBack={backToDashboard} userRole={userRole} /></ProtectedRoute>;
      ...
      case ViewState.CREATE_ACCOUNT: 
        return (
            <ProtectedRoute requiredPermission={Permission.MANAGE_USERS} userRole={userRole} onBack={backToDashboard}>
                <CreateAccount onBack={backToDashboard} userRole={userRole} />
            </ProtectedRoute>
        );
      case ViewState.DEVELOPER: return <ProtectedRoute requiredPermission={Permission.ACCESS_DEVELOPER_CONSOLE} userRole={userRole} onBack={backToDashboard}><DeveloperConsole onBack={backToDashboard} /></ProtectedRoute>;
