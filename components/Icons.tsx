...
export const AppLogo = ({ className }: { className?: string }) => (
  <div className={`relative flex items-center justify-center overflow-visible group ${className}`}>
    <div className="absolute inset-0 bg-yellow-400/20 rounded-full blur-xl scale-125 animate-pulse group-hover:bg-yellow-400/40 transition-all duration-700"></div>
    <img 
      src="https://lh3.googleusercontent.com/d/1qEacwHH2BlK-Z6VyY98NVI9fzv6VqE0r" 
      alt="IMAM Logo" 
      className="w-full h-full object-contain transition-all duration-700 hover:scale-110 drop-shadow-[0_0_15px_rgba(234,179,8,0.5)] relative z-10"
...
export const ImamLogo = AppLogo;

export const SignalIcon = ({ className }: { className?: string }) => (
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className={className}>
    <path d="M20 18h2v-8h-2v8zm-4 0h2v-5h-2v5zm-4 0h2V8h-2v10zm-4 0h2v-3H8v3zm-4 0h2v-1H4v1z" />
  </svg>
);

export const WifiIcon = ({ className }: { className?: string }) => (
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className={className}>
    <path d="M12 21l-12-11.647c4.131-4.013 9.431-6.19 12-6.19s7.869 2.177 12 6.19l-12 11.647z" />
  </svg>
);

export const BatteryIcon = ({ className }: { className?: string }) => (
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className={className}>
    <path d="M17 6h-2V4H9v2H7c-1.1 0-2 .9-2 2v12c0 1.1.9 2 2 2h10c1.1 0 2-.9 2-2V8c0-1.1-.9-2-2-2z" />
  </svg>
);
...
export const IdentificationIcon = ({ className }: { className?: string }) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M15 9h3.75M15 12h3.75M15 15h3.75M4.5 19.5h15a2.25 2.25 0 0 0 2.25-2.25V6.75A2.25 2.25 0 0 0 19.5 4.5h-15a2.25 2.25 0 0 0-2.25 2.25v10.5a2.25 2.25 0 0 0 2.25 2.25Zm.75-12h3.75c.621 0 1.125.504 1.125 1.125v3.75c0 .621-.504 1.125-1.125 1.125H5.25a1.125 1.125 0 0 1-1.125-1.125v-3.75c0-.621.504-1.125 1.125-1.125Z" />
    </svg>
);

export const RobotIcon = ({ className }: { className?: string }) => (
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className}>
    <path strokeLinecap="round" strokeLinejoin="round" d="M8.25 3v1.5M4.5 8.25H3m18 0h-1.5M4.5 12h1.5m12 0h1.5m-15 3.75h3m-3.75 3.75h15A2.25 2.25 0 0 0 21 17.25V8.25a2.25 2.25 0 0 0-2.25-2.25H5.25A2.25 2.25 0 0 0 3 8.25v9a2.25 2.25 0 0 0 2.25 2.25Z" />
  </svg>
);
...
export const UsersGroupIcon = ({ className }: { className?: string }) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M18 18.72a9.094 9.094 0 0 0 3.741-.479 3 3 0 0 0-4.682-2.72m.94 3.198.001.031c0 .225-.012.447-.037.666A11.944 11.944 0 0 1 12 21c-2.17 0-4.207-.576-5.963-1.584A6.062 6.062 0 0 1 6 18.719m12 0a5.971 5.971 0 0 0-.941-3.197m0 0A5.995 5.995 0 0 0 12 12.75a5.995 5.995 0 0 0-5.058 5.472m0 0a5.995 5.995 0 0 0-4.293-5.774M6.228 6.228A4.044 4.044 0 0 1 9 4.875c1.11 0 2.155.45 2.923 1.187M12.75 7.875a4.125 4.125 0 1 1-8.25 0 4.125 4.125 0 0 1 8.25 0ZM16.5 7.5a3.75 3.75 0 1 1-7.5 0 3.75 3.75 0 0 1 7.5 0Z" />
    </svg>
);

export const UsersIcon = UsersGroupIcon;
...
export const CalendarIcon = ({ className }: { className?: string }) => (
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className}>
    <path strokeLinecap="round" strokeLinejoin="round" d="M6.75 3v2.25M17.25 3v2.25M3 18.75V7.5a2.25 2.25 0 0 1 2.25-2.25h13.5A2.25 2.25 0 0 1 21 7.5v11.25m-18 0A2.25 2.25 0 0 0 5.25 21h13.5A2.25 2.25 0 0 0 21 18.75m-18 0v-7.5A2.25 2.25 0 0 1 5.25 9h13.5A2.25 2.25 0 0 1 21 9v7.5m-18 0h18" />
  </svg>
);
...
export const BriefcaseIcon = ({ className }: { className?: string }) => (
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className}>
    <path strokeLinecap="round" strokeLinejoin="round" d="M20.25 14.15v4.25c0 .414-.336.75-.75.75H4.5a.75.75 0 0 1-.75-.75v-4.25m16.5 0a2.25 2.25 0 0 0-2.25-2.25H18m2.25 2.25H18m0-2.25V4.5a2.25 2.25 0 0 0-2.25-2.25H8.25A2.25 2.25 0 0 0 6 4.5v7.4m12 0V12m-12 0v1.25m12-1.25c0 1.242-1.008 2.25-2.25 2.25H8.25A2.25 2.25 0 0 1 6 13.25V12" />
  </svg>
);
...
export const CommandLineIcon = ({ className }: { className?: string }) => (
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className}>
    <path strokeLinecap="round" strokeLinejoin="round" d="M6.75 7.5 3 11.25m3.75 3.75L3 11.25m10.5 3.75h6.75V7.5" />
  </svg>
);
...
export const RectangleStackIcon = ({ className }: { className?: string }) => (
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className}>
    <path strokeLinecap="round" strokeLinejoin="round" d="M6 6.878V6a2.25 2.25 0 0 1 2.25-2.25h7.5A2.25 2.25 0 0 1 18 6v.878m-12 0c.235-.083.487-.128.75-.128h10.5c.263 0 .515.045.75.128m-12 0A2.25 2.25 0 0 0 4.5 9v.878m13.5-3A2.25 2.25 0 0 1 19.5 9v.878m-15 0A2.25 2.25 0 0 0 3 12.122V18a2.25 2.25 0 0 0 2.25 2.25h13.5A2.25 2.25 0 0 0 21 18v-5.878a2.25 2.25 0 0 0-1.5-2.122m-15 0A2.25 2.25 0 0 1 6 9.878m13.5 0A2.25 2.25 0 0 1 18 12.122" />
  </svg>
);
...
export const BanknotesIcon = ({ className }: { className?: string }) => (
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className}>
    <path strokeLinecap="round" strokeLinejoin="round" d="M2.25 18.75a60.07 60.07 0 0 1 15.797 2.101c.727.198 1.453-.342 1.453-1.096V18.75M3.75 4.5v.75m0 1.5V9m0 1.5V12m0 1.5v.75m0 0h.75m0 0h13.5m0 0h.75m-20.25 0h.75m0 0h13.5m0 0h.75M6.75 20.25v.75m0-1.5v-1.5m0-1.5v-1.5m0-1.5v-.75m0 0h.75m0 0h13.5m0 0h.75m-20.25 0h.75m0 0h13.5m0 0h.75m-16.5-15h16.5a2.25 2.25 0 0 1 2.25 2.25v10.5a2.25 2.25 0 0 1-2.25 2.25H3.75a2.25 2.25 0 0 1-2.25-2.25V6.75a2.25 2.25 0 0 1 2.25-2.25Z" />
  </svg>
);

export const CloudIcon = ({ className }: { className?: string }) => (
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className}>
    <path strokeLinecap="round" strokeLinejoin="round" d="M2.25 15a4.5 4.5 0 0 0 4.5 4.5H18a3.75 3.75 0 0 0 0-7.5h-.75a6 6 0 1 0-11.75 0h-.75a4.5 4.5 0 0 0-4.5 4.5Z" />
  </svg>
);
...
// Added ClipboardDocumentCheckIcon
