...
const Sidebar: React.FC<SidebarProps> = ({ currentView, onNavigate, userRole = UserRole.GURU, onLogout, onClose }) => {
  ...
  const menuItems: SidebarItem[] = [
    ...
    { label: 'Data kelas', icon: BookOpenIcon, view: ViewState.CLASSES, requiredPermission: Permission.VIEW_CLASSES },
    { label: 'Jadwal pelajaran', icon: CalendarIcon, view: ViewState.SCHEDULE },
    { label: 'Jurnal mengajar', icon: BookOpenIcon, view: ViewState.JOURNAL, requiredPermission: Permission.VIEW_JOURNAL },
