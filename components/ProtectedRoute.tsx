...
import { hasPermission, type Permission } from '../src/auth/rbac';
...
const ProtectedRoute: React.FC<ProtectedRouteProps> = ({
  ...
  const isAllowedByRole = allowedRoles ? allowedRoles.includes(userRole) : true;
  const isAllowedByPermission = requiredPermission ? hasPermission(userRole, requiredPermission) : true;
