...
export const RolePermissions: Readonly<Record<RoleValue, readonly PermissionValue[]>> = {
  ...
  [Role.KEPALA_MADRASAH]: [Permission.VIEW_DASHBOARD, Permission.VIEW_CLASSES, Permission.VIEW_JOURNAL, Permission.VIEW_REPORTS, Permission.VIEW_ANALYTICS, Permission.MANAGE_SYSTEM, Permission.APPROVE_RAPOR],
  [Role.WALI_KELAS]: [Permission.VIEW_DASHBOARD, Permission.MANAGE_ATTENDANCE, Permission.MANAGE_ACADEMIC, Permission.VIEW_CLASSES, Permission.VIEW_JOURNAL, Permission.INPUT_NILAI, Permission.VIEW_SISWA],
  [Role.STAF_TU]: [Permission.VIEW_DASHBOARD, Permission.MANAGE_USERS, Permission.VIEW_USERS, Permission.VIEW_SISWA, Permission.EDIT_SISWA, Permission.VIEW_CLASSES, Permission.VIEW_JOURNAL],
  [Role.WAKA_KURIKULUM]: [Permission.VIEW_DASHBOARD, Permission.MANAGE_ACADEMIC, Permission.VIEW_CLASSES, Permission.VIEW_JOURNAL, Permission.VIEW_REPORTS, Permission.APPROVE_RAPOR],
